...
export function AltovisualPortraitStatic() {
  ...
  return (
    <div className="altovisual-portrait-static-container flex justify-center my-4">
      <div
        ref={containerRef}
        ...
        aria-label="Static Altovisual portrait with 3D effect"
      >
        <div className="relative overflow-hidden">
          ...
          >
            {/* Pre-processed Altovisual art with color spans would go here */}
